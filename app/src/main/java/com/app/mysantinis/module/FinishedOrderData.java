...
public class FinishedOrderData {
    ...
    public FinishedOrderData(String text1, String text2, String[] text4, TableLayout tblLayout, String totaltax, String cname, String cphone, String cemail, String wordpressID, String cloverID) {
        this.text1 = text1;
        this.text2 = text2;
        this.text4 = text4;
