...
public class IncomingOrdersAdapter extends RecyclerView.Adapter<IncomingOrdersAdapter.AppViewHolder> {

    JSONArray orderArray;
    IncomingOrdersFragment fragment;
    ...
    public IncomingOrdersAdapter(IncomingOrdersFragment context, JSONArray orderArray, OnItemClickListener listener ) {
...
//            txtPending = itemView.findViewById(R.id.txt_pending);
...
//            holder.txtStauts.setText(currentItem.getString("status"));
...
//            if(currentItem.getString("status").equals("pending")) {
