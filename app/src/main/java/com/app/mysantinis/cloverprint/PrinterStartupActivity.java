...
import com.app.mysantinis.cloverprint.barcode.BarcodeCaptureActivity;
...
public class PrinterStartupActivity extends AppCompatActivity {

  public static final String TAG = PrinterStartupActivity.class.getSimpleName();
  public static final String APP_NAME = "SANTIS";
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    setContentView(R.layout.activity_clover_printer_startup);
    ...
    group.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
      ...
      public void onCheckedChanged(RadioGroup group, int checkedId) {
        TextView textView = findViewById(R.id.lanPayDisplayAddress);
    ...
    // initialize...
    TextView textView = findViewById(R.id.lanPayDisplayAddress);
    String url = this.getSharedPreferences(APP_NAME, Context.MODE_PRIVATE).getString(LAN_PAY_DISPLAY_URL,  "wss://192.168.1.101:12345/remote_pay");

    textView.setText(url);
    textView.setEnabled(((RadioGroup)findViewById(R.id.radioGroup)).getCheckedRadioButtonId() == R.id.lanRadioButton);

    String mode = this.getSharedPreferences(APP_NAME, Context.MODE_PRIVATE).getString(CONNECTION_MODE, USB);
  ...
  private boolean loadBaseURL() {
    ...
    String _serverBaseURL = PreferenceManager.getDefaultSharedPreferences(this).getString(POSActivity.EXAMPLE_POS_SERVER_KEY, "wss://10.0.0.101:12345/remote_pay");

    TextView tv = findViewById(R.id.lanPayDisplayAddress);
  ...
  public void connect(View view, boolean clearToken) {
    ...
    RadioGroup group = findViewById(R.id.radioGroup);
    SharedPreferences prefs = this.getSharedPreferences(APP_NAME, Context.MODE_PRIVATE);
...
//      intent.putExtra(MainActivity.EXTRA_CLOVER_CONNECTOR_CONFIG, config);
//      intent.putExtra(MainActivity.EXTRA_CLEAR_TOKEN, clearToken);
//      intent.putExtra(MainActivity.EXTRA_WS_ENDPOINT, uri);
