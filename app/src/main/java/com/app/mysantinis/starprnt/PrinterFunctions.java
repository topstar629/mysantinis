...
public class PrinterFunctions {
    ...
    public static byte[] createRasterReceiptData(Emulation emulation, ILocalizeReceipts localizeReceipts, Resources resources) {
        ...
        localizeReceipts.createRasterReceiptImage(builder,resources);
    ...
    public static byte[] createRasterCloseOutData(Emulation emulation, ILocalizeReceipts localizeReceipts, Resources resources) {
        ICommandBuilder builder = StarIoExt.createCommandBuilder(emulation);

        builder.beginDocument();

        localizeReceipts.createRasterCloseOutImage(builder,resources);
    ...
    public static byte[] createTextCloseOutData(Emulation emulation, ILocalizeReceipts localizeReceipts, boolean utf8) {
        ICommandBuilder builder = StarIoExt.createCommandBuilder(emulation);

        builder.beginDocument();

        localizeReceipts.appendTextCloseOutData(builder, utf8);
