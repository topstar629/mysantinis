...
public class CommonActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(intent.getIntExtra(CommonActivity.BUNDLE_KEY_ACTIVITY_LAYOUT, R.layout.activity_printer_setup));  // Display a user selected menu list.
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        if (intent.getBooleanExtra(CommonActivity.BUNDLE_KEY_SHOW_RELOAD_BUTTON, false)) {
            getMenuInflater().inflate(R.menu.menu_main_print, menu);
        }
